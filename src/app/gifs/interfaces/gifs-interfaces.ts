// To parse this data:
//
//   import { Convert, BusquedaGIF } from "./file";
//
//   const busquedaGIF = Convert.toBusquedaGIF(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface BusquedaGIF {
    data:       Gif[];
...
export class Convert {
    public static toBusquedaGIF(json: string): BusquedaGIF {
        return cast(JSON.parse(json), r("BusquedaGIF"));
    }

    public static busquedaGIFToJson(value: BusquedaGIF): string {
        return JSON.stringify(uncast(value, r("BusquedaGIF")), null, 2);
    }
}
